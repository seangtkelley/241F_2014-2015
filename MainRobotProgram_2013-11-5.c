...
#pragma config(Motor,  port1,           leftArm,       tmotorVex393, openLoop, encoder, encoderPort, I2C_2, 1000)
#pragma config(Motor,  port2,           rightArm,      tmotorVex393, openLoop, reversed, encoder, encoderPort, I2C_1, 1000)
