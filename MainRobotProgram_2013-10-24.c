...
#pragma config(Motor,  port3,           backLeft,      tmotorVex393, openLoop, reversed, encoder, encoderPort, I2C_3, 1000)
#pragma config(Motor,  port4,           backRight,     tmotorVex393, openLoop, encoder, encoderPort, I2C_4, 1000)
